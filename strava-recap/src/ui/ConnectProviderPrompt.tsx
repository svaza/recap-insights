    ...
    return (
        <div className="d-flex flex-column gap-3">
            ...
            <p className="text-body-secondary small mb-0 connect-provider-tip">
                Tip: If you have an{" "}
                <span className="provider-name provider-name--intervals">Intervals.icu</span> account, connect that one — it avoids{" "}
                <span className="provider-name provider-name--strava">Strava</span> rate limits.
            </p>
