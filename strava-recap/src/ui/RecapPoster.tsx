        ...
        >
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", gap: 16 }}>
                <div>
                    ...
                    <div style={{ fontSize: 36, fontWeight: 950, letterSpacing: -1, lineHeight: 1.1, opacity: 0.9 }}>
                        Recap Insights
                    </div>
                    ...
                    {props.breakdownRows.slice(0, 4).map((r) => (
                        ...
                        >
                            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                                ...
                                <div style={{ fontWeight: 900, fontStyle: "italic" }}>{r.type}</div>
                            </div>
            ...
            >
                <div>generated using recapinsights.link</div>
                <div>Data: Strava & intervals.icu</div>
            </div>
        </div>
    );
}
